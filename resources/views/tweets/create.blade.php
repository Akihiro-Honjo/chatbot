      ...
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
          <form method="POST" action="{{ route('tweets.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
              <!-- Genre -->
              <label for="genre" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">ジャンル</label>
              <select name="genre" id="genre" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <option value="シール">シール</option>
                <option value="オフ">オフ</option>
                <option value="軟包材">軟包材</option>
